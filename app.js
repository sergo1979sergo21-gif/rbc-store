...
function updateText() {
  ...
  const favoritesNavBtn = document.querySelector("button.nav-favorites");
  ...
  if (favoritesNavBtn) favoritesNavBtn.setAttribute("aria-label", translations[lang].favoritesNav);
